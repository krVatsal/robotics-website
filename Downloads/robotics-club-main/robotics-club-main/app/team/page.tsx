...
const defaultTeamData = {
  faculty: [
    { name: "Dr. Rajesh Kumar", role: "Faculty Advisor", dept: "Mechanical Engineering" },
    { name: "Dr. Anita Srivastava", role: "Co-Advisor", dept: "Electronics & Communication" },
  ],
  coordinators: [
    { name: "Aarav Mehta", role: "President", year: "Final Year · ME", bio: "Leading the club's strategic direction and competition portfolio. 3 years in autonomous systems." },
    { name: "Priya Sharma", role: "Vice President", year: "Final Year · ECE", bio: "Oversees all technical verticals. Built our LiDAR perception pipeline from scratch." },
    { name: "Vikram Singh", role: "Technical Head", year: "Pre-Final · CSE", bio: "ROS 2 architect and simulation lead. Manages the software stack across all projects." },
  ],
  leads: [
    { name: "Rohan Gupta", role: "Mechanical Lead", vertical: "Mechanical" },
    { name: "Sneha Verma", role: "Electronics Lead", vertical: "Electronics" },
    { name: "Ananya Rao", role: "CV Lead", vertical: "Computer Vision" },
    { name: "Karan Patel", role: "Software Lead", vertical: "Software" },
    { name: "Meera Iyer", role: "Design Lead", vertical: "CAD & Fabrication" },
    { name: "Arjun Nair", role: "Outreach Lead", vertical: "Events & PR" },
  ],
  members: [
...
export default function TeamPage() {
  const { content } = useSiteContent("team-page", defaultTeamData)
  const data = content ?? defaultTeamData
  const { faculty, coordinators, leads, members, verticals, stats } = data
  return (
